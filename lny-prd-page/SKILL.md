...
| 详情 | PAGE-MP-003 | 返回叠 16:9 → 图文介绍 → 评论 → 贴底次要操作 | 时间行；附图 1:1、一排最多五张；点图片放大阅览，同页一组不循环 |
...
| 详情 | PAGE-AD-008 | 面包屑 → 16:9 图集 → 图文介绍 → 评论 → 次要操作 | 无页内大标题；时间行；附图 1:1、一排最多五张；点图片放大阅览，同页一组不循环 |
