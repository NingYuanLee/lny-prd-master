...
(function (global) {
  ...
  var ICONS = {
    ...
    "radio-off": "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z",
    ...
    /* 启用 / 停用（操作列图标） */
    enable: "M17 7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h10c2.76 0 5-2.24 5-5s-2.24-5-5-5zm0 8c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z",
    disable: "M17 7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h10c2.76 0 5-2.24 5-5s-2.24-5-5-5zM7 15c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z",
    unfold: "M12 5.83L15.17 9l1.41-1.41L12 3 7.41 7.59 8.83 9 12 5.83zm0 12.34L8.83 15l-1.41 1.41L12 21l4.59-4.59L15.17 15 12 18.17z",
    fold: "M7.41 18.59L8.83 20 12 16.83 15.17 20l1.41-1.41L12 14l-4.59 4.59zm9.18-13.18L15.17 4 12 7.17 8.83 4 7.41 5.41 12 10l4.59-4.59z"
  };
  ...
  var ALIAS = {
    ...
    "更多": "more",
    "启用": "enable", "开启": "enable",
    "停用": "disable", "禁用": "disable",
    "成功": "check",
    "未选": "radio-off", "未选中": "radio-off",
    "失败": "error", "错误": "error",
    "警告": "warning",
    "信息": "info",
    "空": "empty", "空态": "empty",
    ...
    "向右": "chevron-right",
    "后退": "chevron-left",
    "返回顶部": "arrow-up", "顶部": "arrow-up", "向上": "arrow-up",
    "目录": "list", "列表": "list",
    "全部展开": "unfold", "展开全部": "unfold",
    "全部收起": "fold", "收起全部": "fold"
  };
