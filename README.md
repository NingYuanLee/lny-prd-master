...
|----------|---------:|---------:|---------:|-----:|
| PAGE-MP-004 | 1.0（支线） | 0（少量） | 1.0 | 1.0 |
| PAGE-MP-001 | 1.5（主流程） | 0（少量） | 0.6 | 0.9 |
| **小计（①）** | | | | **1.9** |
...
|----------|---------:|---------:|---------:|-----:|
| PAGE-MP-004 | 0.5（标准） | 1（精致） | 1.0 | 1.5 |
| PAGE-MP-001 | 0.5（标准） | 0.5（标准） | 0.6 | 0.6 |
| **小计（②）** | | | | **2.1** |
...
|----------|--------:|---------:|---------:|-----:|
| PAGE-MP-001 | 0.5（一般） | 0（单请求或并行） | 0.6 | 0.3 |
| PAGE-MP-004 | 0（少量） | 0（单请求或并行） | 1.0 | 0 |
| **小计（③）** | | | | **0.3** |
