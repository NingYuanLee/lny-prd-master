...
> **FE §2.1～§2.3** 按三维分表；**BE §3.1** 仅 AD 页；**②～④** 分节；各明细行 **按小计降序**；§1 / §2.4 / §3.5 加粗汇总。
...
|----------|---------:|---------:|---------:|-----:|
| PAGE-MP-001 | 2.0（主流程） | 0.5（少量） | 0.6 | 1.5 |
| PAGE-MP-004 | 1.0（支线） | 0.5（少量） | 1.0 | 1.5 |
| **小计（①）** | | | | **3.0** |
...
|----------|---------:|---------:|---------:|-----:|
| PAGE-MP-004 | 1（标准） | 2（精致） | 1.0 | 3.0 |
| PAGE-MP-001 | 1（标准） | 1（标准） | 0.6 | 1.2 |
| **小计（②）** | | | | **4.2** |
...
|----------|--------:|---------:|---------:|-----:|
| PAGE-MP-001 | 1.5（一般） | 0.5（单请求或并行） | 0.6 | 1.2 |
| PAGE-MP-004 | 0.5（少量） | 0.5（单请求或并行） | 1.0 | 1.0 |
| **小计（③）** | | | | **2.2** |
